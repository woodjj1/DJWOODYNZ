...
$_SETTINGS = [
	"to"						=> "djwoody09@gmail.com",							// To Address
	"toAlt"						=> "",						// Additional Recipients
	"from"						=> "djwoody09@gmail.com",						// From Address
	"fromName"					=> "Woody",					// From Name
	...
	"template"					=> "Kia ora,<br><br>You have received a new message from your website.<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>Have a nice day.",					// Mail Template
